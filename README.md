...
> 欢迎来到家豪的博客！这里是一个关于视觉、特效、艺术的平台。家豪的博客旨在探索各种不同的艺术风格，包括视觉特效、影视后期、艺术创作和更多。
...
```yml
title: 家豪的博客
subtitle: 视觉特效、影视技术、艺术设计
description: 欢迎来到家豪的博客！这里是一个关于视觉、特效、艺术的平台。家豪的博客旨在探索各种不同的主题，包括视觉特效、影视后期、艺术创作和更多。
keywords:
# 作者名称，会显示在侧边栏
author: JH
```
