...
> 欢迎来到家豪的博客！这里是一个关于科技、创新和思想的平台。家豪的博客旨在探索各种不同的主题，包括人工智能、区块链、虚拟现实、环境保护、社会正义和更多。
...
```yml
title: 家豪的博客
subtitle: 发现未知、拓展思维、超越想象
description: 欢迎来到家豪的博客！这里是一个关于科技、创新和思想的平台。家豪的博客旨在探索各种不同的主题，包括人工智能、区块链、虚拟现实、环境保护、社会正义和更多。
keywords:
# 作者名称，会显示在侧边栏
author: JH
```
...
```sh
# 克隆仓库
$ git clone https://github.com/zizhuspot/haojia.git
# 安装依赖
$ yarn install
# 运行
$ yarn server
